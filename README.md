...
| **Workshop**   | A practitioner, a safety engineer | The Control Room: runs, the Spec Lab and Run Lab, guards, evaluators, scenarios, campaigns, telemetry and drift, conduct and model risk, the safety case, the assurance pack, evidence sync. |
