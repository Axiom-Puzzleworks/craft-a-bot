...
5. Commission the art (WP18) now — it is the longest external lead time and blocks the tag.
6. Revisit this roadmap at the end of each phase; amendments get dated notes here, as ever.
