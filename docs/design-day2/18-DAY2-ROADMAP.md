...
7. Next: **WP20** (Run Browser + Run Lab) reads the same stored runs and is unblocked. The **live lane** needs a spend decision before it can produce the numbers WP19's DoD names — it is the only part of Phase C that cannot be finished from a coding session.
8. Revisit this roadmap at the end of each phase; amendments get dated notes here, as ever.
