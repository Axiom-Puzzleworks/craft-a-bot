...
> **Amended 2026-08-13 (WP13):** E1, E2, E5, E8, E9, E10 and E11 have landed. **E6 has not** — world action and sense ids are still unqualified, and the two `it.fails` markers in `ids.test.ts` still stand. Notes on where the implementation differs from the rows above:
>
