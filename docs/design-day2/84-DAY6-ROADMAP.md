...
3. **WP94 stages B–C** — the adapters and the identity test. Nothing else merges until it is green.
4. **WP95, WP96, WP97** — in any order, in parallel.
