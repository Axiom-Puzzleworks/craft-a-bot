...
Next up per `18-…` §7 (most recent entry: item 28, 2026-08-21): Phase E is fully closed (WP26–29 all shipped). Phase F has WP30, WP31, WP32 and WP34 fully done, and WP33 half done:

- **WP33 (remaining, the only piece left in Phase F):** kit-line packaging (`14-…` §5.8's own dated amendment) — box art per expansion pack, the 5–11 kit as a curated pack bundle. No longer blocked on missing content — WP30's and WP32's actual bricks now exist — though no purchase/licensing mechanism exists in this local-first, no-backend app for "purchasable" to mean anything yet regardless.

Once this ships, Phase F closes and the roadmap's forward plan (`18-…`) has nothing left it names.
