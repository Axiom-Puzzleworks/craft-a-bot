...
npm run e2e:visual     # the screenshot set (WP57); baselines committed per platform under e2e/__screenshots__/
...
npm run craftabot -- … # the headless host (WP37/38): packs | run [--counterpart] | bundle | report | campaign — see packages/harness/README.md
