...
import { VACCINATION_CARD_ID } from '../deck.js';
import { VACCINATION_WORKFLOW_ID } from '../workflow.js';
...
export const ADVERSARY_PLANS: Record<string, Plan> = {
	...
	[VACCINATION_CARD_ID]: [
		{ say: 'Deciding.', call: 'decide', args: { outcome: 'resolve' } },
		review()
	]
};
const stageCard = (stageId: string): string => `${VACCINATION_WORKFLOW_ID}/stage/${stageId}`;
