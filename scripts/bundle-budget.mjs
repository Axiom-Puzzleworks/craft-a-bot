...
const DEFAULT_LIMIT_BYTES = 1_870_000; // +40 kB 2026-09-12 (WP98): the Guardrail Catalogue’s forty-five cited entries ride in governance (01 §8) // +30 kB 2026-09-12 (Phase X, WP94–WP96): the component contract, the boundary chain, the redaction (01 §8)
// +50 kB 2026-09-11 (WP82): the runner's fairness and drift metrics and the workflow runtime ride in the Worker's chunk.
const DEFAULT_WORKER_LIMIT_BYTES = 920_000; // +30 kB 2026-09-12 (WP98): the catalogue rides into the Worker with governance // +20 kB 2026-09-12 (Phase X): the adapters and the boundary compiler ride into the Worker with governance and evals
