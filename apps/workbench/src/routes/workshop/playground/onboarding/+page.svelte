...
<section aria-label="The boundary">
	...
	<p>
		...
		boundary, and the bank’s <code>kyc</code> line outside — the same screening function the desk’s
		truth reads. The build <code>campaigns/fs-onboarding-baseline.json</code> runs under three guards,
		with the tipping-off pair as its gates.
	</p>
