...
export const EDITIONS: Record<EditionId, Edition> = {
	simulator: {
		...
		budgetBytes: 1_770_000 // +15 kB 2026-09-07 (WP73): the wave 2 placeholders inlined as markup; +25 kB the same day (the UX pass); +10 kB 2026-09-10 (WP79): core's workflow types and events; +260 kB 2026-09-11 (WP91, `81-…` §4): the Day 5 Workshop screens — every route's chunk ships in every edition, only the packs differ, and the budget had not followed since WP84; +30 kB 2026-09-12 (Phase X, WP94–WP96, `01-…` §8): `GuardrailComponent` and the registry's index in `core`, the adapters and `compileComponents` in `governance`, the boundary chain in the workflow runtime, the redaction on the session and the transcript
	},
	workshop: {
		id: 'workshop',
		title: 'The Workshop',
