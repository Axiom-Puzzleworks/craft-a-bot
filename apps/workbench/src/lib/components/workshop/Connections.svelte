<script lang="ts">
	...
	/**
	 * **The Guard Rack** — since WP101 the Studio's *Connections* tab (`88-STUDIO.md` §7), moved whole.
	 * (`30-SECOND-VENDORS.md` §5, WP42): every registered
...
<div class="rack" data-testid="guard-rack">
	<h1>Guards</h1>
	<p class="hint">
