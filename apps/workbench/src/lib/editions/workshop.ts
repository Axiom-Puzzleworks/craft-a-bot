...
/**
 * **The `workshop` edition's packs** (`59-EDITIONS.md` §4.1, WP69): the Kit's box plus the guard services, the
 * evaluators, the evidence store and the generic control map.
